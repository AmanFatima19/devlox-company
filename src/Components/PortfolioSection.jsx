        ...
        {portfolioItems.map((item, index) => (
          <div
            ...
            className="relative w-full max-w-sm rounded-xl overflow-hidden 
                       ...
                       shadow-md hover:shadow-[0_0_25px_#ff5521]/40 
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {item.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="bg-white/10 text-gray-200 text-xs font-medium px-3 py-1 
                               rounded-full border border-gray-500/30 hover:border-[#ff5521] 
